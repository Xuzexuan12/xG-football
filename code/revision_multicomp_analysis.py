...
OUT_DIR = ROOT / "sage_latex_template_4" / "revision_outputs"
OUT_DIR.mkdir(parents=True, exist_ok=True)
FRONTIERS_OUT_DIR = ROOT / "frontiers_submission" / "results"
...
def mirror_frontiers_results() -> None:
    FRONTIERS_OUT_DIR.mkdir(parents=True, exist_ok=True)
    for path in OUT_DIR.glob("*.csv"):
        shutil.copyfile(path, FRONTIERS_OUT_DIR / path.name)
